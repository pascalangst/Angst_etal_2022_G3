#!/usr/bin/perl
#taken from https://github.com/ISUgenomics/common_scripts/blob/master/gff2fasta.pl and modified as needed 04/16/19
#originally from https://www.biostars.org/p/46281/ and modified as needed 10/15/15
use strict;
use warnings;
use Bio::Seq;
use Bio::SeqIO;
