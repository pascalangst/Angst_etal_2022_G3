#!bin/python
# taken from https://gist.github.com/danielecook/cfaa5c359d99bcad3200#file-generate_masked_ranges-py and modified as needed 04/16/19
import gzip
import io
import sys
import os
...
if len(sys.argv) > 1:
    ...
    elif sys.argv[1].endswith(".fa") or sys.argv[1].endswith(".txt") or sys.argv[1].endswith(".fasta") or sys.argv[1].endswith(".fas"):
